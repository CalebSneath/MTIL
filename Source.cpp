...
//       
// Requirements: 
//      - Ensure VS Code compiler is setup correctly, uses G++, 
...
//      game.h      : a file including the the game class header information
//      game.cpp    : a file including the game class implementation details
...
#include <Windows.h>
#include "integration_inputs.cpp"
#include "integration_outputs.cpp"
